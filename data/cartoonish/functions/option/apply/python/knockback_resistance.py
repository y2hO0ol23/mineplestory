uuidform = "636172746f6f6e6b627265736f7074"
...
with open(".\\data\\cartoonish\\functions\\option\\apply\\type\\"+ name +".mcfunction",'a') as f:
    ...
    while i > 0:
        ...
        if (i*5) % 1000 < 10:
            ...
            z = "0"
        f.write('execute if score @s TEMP matches ' + str(i) + '.. run attribute @s '+ attribute +' modifier add ' + uuidform + hex(cnt)[2:] + ' "ct_option" ' + str((i*5)//1000) + '.' + z + str((i*5)%1000) + ' add\n')
