...
execute store result score @s TEMP run data get storage cartoonish:option/table upgrade[0] 10
scoreboard players operation @s TEMP *= @s CAL
execute if score @s random_data < @s TEMP run data modify storage cartoonish:option/table target.tag.grade set value 1